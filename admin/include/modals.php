...
<script type="text/javascript">
    ...
    var baselink = "admin/downloader.php?q=";
    <?php 
    } ?>
</script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-title">
                        <div class="input-group">
                            <span class="input-group-btn">
                                <a class="fmlink btn btn-primary" href="#">
    ...
    function loadImg(thislink, thislinkencoded, thisname, thisID){
        $(".zoom").html("<i class=\"fa fa-refresh fa-spin\"></i><img class=\"preimg\" src=\"thumb.php?thumb="+ thislink +"&y=1\" \/>");
        $("#zoomview").data('id', thisID);
        $("#zoomview .thumbtitle").val(thisname);
        var firstImg = $('.preimg');
